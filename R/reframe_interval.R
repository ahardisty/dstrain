...
reframe_wea_db <- function(wea_yr = 2017, tou = "hetoua", wea_id = "(1, 22, 23)", wea_src = "PGE", train = TRUE  {
...
lapply(wea_tou_query[[1]], function(x) readr::write_lines(wea_tou_query[[1]], path  = 'data/sql/query.sql')

lapply(, function(x) readr::write_file(x, )
